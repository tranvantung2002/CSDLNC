...
public class Menu extends JPanel {
    ...
    private final String[][] menuItems = {
            ...
            {"Dashboard"},
            {"~WEB APP~"},
            {"Quản lý sản phầm", "Danh sách sản phẩm", "Danh sách loại sản phẩm", "Danh sách hãng sản xuất"},
            {"Quản lý quyền hạn", "Danh sách quyền sử dụng", "Danh sách người dùng"},
    ...
    private final String headerName = "Quản lý bán hàng";
